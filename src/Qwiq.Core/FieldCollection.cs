...
namespace Qwiq
{
    public class FieldCollection : IFieldCollection
    {
        ...
        internal FieldCollection( IRevisionInternal revision, IFieldDefinitionCollection definitions, Func<IRevisionInternal, IFieldDefinition, IField> fieldFactory)
        {
            _revision = revision;
